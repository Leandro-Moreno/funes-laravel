  ...
  <b-form-group label="Arbitrado por especialistas" v-slot="{ ariaDescribedby }">
    ...
    <b-form-group for="estado_id" label="Estado" v-slot="{ ariaDescribedbyd }">
      ...
      <b-container fluid>
        <b-row class="my-1">
          <b-col sm="2">
            <label for="tipo_de_publicacion">Título de Publicación/Revista:</label>
          </b-col>
          <b-col sm="10">
            <b-form-input v-model="tipo_de_publicacion" id="tipo_de_publicacion" size="sm" placeholder="Ingrese nombre de la publicación"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col sm="2">
          ...
          <b-col sm="10">
            <b-form-input v-model="issn" id="issn" placeholder="issn"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col sm="2">
          ...
          <b-col sm="10">
            <b-form-input v-model="editor" id="editor" placeholder="Editor"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col sm="2">
          ...
          <b-col sm="10">
            <b-form-input v-model="url_oficial" type="url" id="url_oficial" placeholder="URL oficial"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col sm="2">
          ...
          <b-col sm="10">
            <b-form-input v-model="volumen" type="" id="volumen" placeholder="Volumen"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col sm="2">
        ...
        <b-row class="my-1">
          <b-col sm="2">
          <label for="date_pub">Fecha de Publicación</label>
          </b-col>
          <b-col sm="2">
            <b-form-input v-model="año_publicacion" type="number" id="año_publicacion" placeholder="año_publicacion"></b-form-input>
          </b-col>
          <b-col sm="2">
