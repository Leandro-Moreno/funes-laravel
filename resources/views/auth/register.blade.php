@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Registrarse - ').config('app.name')])
                ...
                <form class="form" method="POST" action="{{ route('register') }}" autocomplete="off">
                    ...
                    <div class="card card-login card-hidden mb-3">
                        ...
                        <div class="card-body ">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="last_name" class="form-control"
                                               placeholder="{{ __('Apellido...') }}" value="{{ old('last_name') }}"
                                               required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12 {{ $errors->has('username') ? ' has-danger' : '' }} mt-3">
                                    <div class="input-group">
                                ...
                                <div class="col-md-6 col-sm-12 {{ $errors->has('email') ? ' has-danger' : '' }} mt-3">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                      <span class="input-group-text">
                  ...
                  <span class="check"></span>
                                    ...
                                    {{ __('Estoy de acuerdo con la ') }} <a
                                        href="#">{{ __('Política de privacidad') }}</a>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="card-footer row ">
                            <div class="col-6">
                                <a href="{{ route('login') }}" class="text-dark">
                                    <smsall>{{ __('¿Ya tiene una cuenta?') }}</smsall>
                                </a>
                            </div>
                            <div class="col-6 text-right">
                                <button type="submit"
                                        class="btn btn-primary btn-lg">{{ __('Crear cuenta') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
