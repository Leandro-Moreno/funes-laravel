            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    @guest()
                        <div class="card">
                            ...
                            <div class="card-body row">
                                <div class="col-sm-12"><p>Los usuarios registrados pueden proponer documentos para su
                                        publicación, guardar búsquedas de su interés y recibir información (por correo
                                        electrónico y RSS) cuando se publiquen nuevos documentos que satisfagan esas
                                        búsquedas.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <div class="col-sm-12"><p>Realizar búsquedas complejas utilizando información múltiple sobre
                                    los registros existentes. Utilice el campo de búsqueda en la parte superior de la
                                    página para una búsqueda rápida.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <div class="col-sm-12"><p>Presentación del contenido de Funes organizada con la estructura
                                    de sus términos clave.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
